...
public class RobotContainer {
  ...
  private final static CommandXboxController xboxControllerDrive = new CommandXboxController(
    ...
    public RobotContainer() {
      ...
      NamedCommands.registerCommand("stop intake", new InstantCommand(()->intakeSubsystem.setRollerVoltage(0)));
    ...
    public double getXSpeed() {
      return xboxControllerDrive.getLeftY();
    }

    public double getYSpeed() {
    return xboxControllerDrive.getLeftX();
    }
